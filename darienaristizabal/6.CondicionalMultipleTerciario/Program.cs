...
namespace _6.CondicionalMultipleTerciario
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ingrese el dia de la semana (L: Lunes M: Nartes, X: Miercoles, J: Jueves, V: Viernes, S: Sábado, D: Domingo):");
            ...
            { 
                ...
                case 'X': //Miercoles
                    Descuento = ValorCompra * 0.10f;
                    Console.WriteLine("Hoy es Miercoles el descuento es de un 10%");
                    break;
                ...
                case 'S': //Sabado
                    Descuento = ValorCompra * 0.20f;
                    Console.WriteLine("Hoy es Sabado el descuento es de un 20%");
                    break;
                ...
                default: // Caso por defecto para manejar dias no validos
                    Console.WriteLine("Día no válido");
                    return; // Salir del programa si el dia no es válido
...

                    {
                        ...
                        case 4: //Multiplicación
                            ...
                            break;
                        default: // Caso por defecto para manejar opciones válidas
